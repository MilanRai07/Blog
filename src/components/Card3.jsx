...
const Card3 = (props) => {
    ...
    return (
        <>
            <div className='h-auto rounded-md w-72 bg-white dark:bgDark dark:shadow-none overflow-hidden shadow-customShadow hover:scale-customScale cursor-pointer'>
                ...
                <div className='p-3'>
                    ...
                    <div>
                        <p className='text-sm sm:text-xs dark:text-stone-400' >{`${news.slice(0, 50)}...`}</p>
                    </div>
