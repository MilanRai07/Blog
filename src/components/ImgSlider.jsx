                        ...
                        <div key={index} className={index == currentImg ? 'opacity-100 duration-1000' : 'opacity-70 duration-1000'}>
                            {
                                ...
                                <div className='w-full h-topImg relative'>
                                    ...
                                    <h1 id='title' className='absolute top-1/3 mlg:top-1/4 left-52 sm:left-28 xs:left-16 xs:w-40 text-white text-2xl mlg:text-xl sm:text-base xs:text-sm bg-textBg p-3 xs:p-2 rounded-md positionSmooth'>{title.slice(0, 50) + '...'}</h1>
